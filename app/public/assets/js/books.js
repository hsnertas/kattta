$(document).ready(function () {
  ...
  document
    ...
    .addEventListener("click", function searchBtn() {
...
$(".book-list").on("click", function (event) {
  ...
  console.log(target);
  let author, genre, title, cover, x;
  if (target.matches("a.add")) {
    (title = event.target.parentElement.children[0].innerHTML),
      ...
      (isbn = event.target.parentElement.children[5].getAttribute("href")),
